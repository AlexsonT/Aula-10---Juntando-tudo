...
function verificarAposentadoria (nome){
  ...
  if(idades >= 65 || temposDeTrabalho >= 30 || idades >= 60 && temposDeTrabalho >= 25){
    return ("Parabéns, já pode sair de férias eternas :)")
  } else if(colaborador != colaboradores){
...
var colaborador = nome('Rhoger')
// console.log verificarAposentadoria = (colaboradores[0])
